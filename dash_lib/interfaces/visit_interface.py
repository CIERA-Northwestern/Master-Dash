...
class Interface:
    ...
    def request_data_axes(
        ...
        with col1:
            ...
            ## I am not entirely sure how the below works but it does
        ...
        if (value=='Origin (International/Domestic)'):
            value = 'ciera_visit_international'
    ...
    def process_filter_settings(
        ...
        if ((value=='Visitor Institution') or (value=='Host')):
            ...
            sort_type, ind1 = selectbox(
                    ...
                    options=['ordered sort', 'manual select','totaled visitors'],   
                )
            ...
            if sort_type == "manual select":
                visit_options = pd.unique(df_cpy[value])
                selected = st_loc.multiselect(label="Specific {} visits to display".format(value),
                                          options=visit_options,
                                          default=None,
                                          max_selections=20,
                                          placeholder="enter visiting institution"
                                          )
            ...
            elif sort_type == "totaled visitors":
                self.settings.common['data']['data_options'] = "Only Total"
                nones = ["N/A", "none", ""]
            ...
            possible_columns = pd.unique(df_cpy[value])
